...
const QRCodeModal = ({ isOpen, onClose, url }) => {
    ...
    const downloadQRCode = () => {
        ...
        if (canvas) {
            ...
            downloadLink.download = "apply-qr-code.png";
                ...
                <div className="text-center space-y-6">
                    ...
                    <div className="flex flex-col space-y-3">
                        <button
                            ...
                            className="w-full py-3 px-6 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-green-100 flex items-center justify-center space-x-2"
                        >
